...
public class MemberDao {
    ...
    public void deletePermanently(String memberId) {
        Member aMember = new Member();   // Instantiate an object to interact with DynamoDB
        aMember.setId(memberId);         // Set the object memberID to the memberId passed to use
        mapper.delete(aMember);          // Tell DynamoDb to delete using the Member object we set up
    }
}
