...
public class Phase0Test {
    private static final String TABLE_NAME_PREFIX = "DynamoDBDeleteIterators-";
    ...
    private final DynamoDB client = new DynamoDB(AmazonDynamoDBClientBuilder.standard().withRegion(Regions.US_WEST_2)
        .build());
